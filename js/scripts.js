        ...
        submitHandler: function(form) {
            jQuery('#contactform').ajaxSubmit({
                ...
                success: function (msg) {
                    jQuery('#message').slideDown().delay(4000).slideUp();
                    jQuery('#contactform').resetForm(true);
                }
            });
        }
    });
...
/* ==============================================
 Contact Form Bigcommerce
 =============================================== */

jQuery(document).ready(function(){
    jQuery("#bigcomform").validate({
        rules: {
            FirstName : {
                required : true,
                minlength : 2
        ...
        submitHandler: function(form) {
            jQuery('#bigcomform').ajaxSubmit({
                type: 'POST',
                url: jQuery(this).attr('action'),
                data: jQuery(this).serialize(),
                success: function (msg) {
                    jQuery('#message').slideDown().delay(4000).slideUp();
                    jQuery('#bigcomform').resetForm(true);
                }
            });
        }
    });
...
$("#map").gmap3({
    marker:{     
	address:"341 Sea Oats Trail, Southern Shores, NC",
